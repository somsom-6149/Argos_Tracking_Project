...
https://datarepository.movebank.org/entities/datapackage/f302d54a-b1e6-4c41-9bc3-456f73686820

Download link: Study Details

Study Name	Satellite tracking of black-capped petrels, 2019
Contact Person	Yvan Satgé
Principal Investigator	Yvan Satgé
Citation	Satgé Y, Keitt BS, Gaskin CP, Patteson JB, Jodice PGR. 2023. Data from: Study "Satellite tracking of black-capped petrels, 2019". Movebank Data Repository. https://doi.org/10.5441/001/1.0786vv78

These data are described in
Satgé YG, Keitt BS, Gaskin CP, Patteson JB, Jodice PGR. 2023. Spatial segregation between phenotypes of the diablotin black-capped petrel Pterodroma hasitata during the non-breeding period. Endanger Species Res. https://doi.org/10.3354/esr01254
...
Grants used	Funding for this research was provided by the Mohamed bin Zayed Species Conservation Fund, American Bird Conservancy, the South Carolina Cooperative Fish and Wildlife Research Unit, and private donors who contributed to American Bird Conservancy’s fundraising campaign.
License Type	
License Terms	Creative Commons Attribution (CC BY). Also see the Movebank General Terms of Use.
Study Summary	Black-capped petrels (Petrodroma hasitata) tracked from at-sea capture locations offshore Cape Hatteras, North Carolina, USA to breeding locations in Haiti and the Dominican Republic.
Study Reference Location	
Longitude	-75.720
Latitude	34.680
Movebank ID	746910348

Study Statistics
Number of Animals	10
Number of Tags	10
Number of Deployments	10
Time of First Deployed Location	2019-05-08 13:51:00.000
Time of Last Deployed Location	2020-01-24 09:46:57.000
Taxa	Pterodroma hasitata
Number of Deployed Locations	4646
Number of Records	Deployed (outliers) / Total (outliers)
  Argos Doppler Shift	4636 (22) / 5249 (23)
  GPS	10 (0) / 10 (0)
...
algorithm marked outlier: Identifies events marked as outliers using a user-selected filter algorithm in Movebank. Outliers have the value TRUE. Information about how outliers were defined can be provided in 'outlier comments'. units: none
...
backpack-harness = The tag is attached to the animal using a backpack-style harness;
...
deployment end type: A categorical classification describing the end of the tag deployment on the animal. Best practice is to clarify how the 'deploy-off timestamp', if present, was chosen. Values are chosen from a controlled list:
...
manually marked outlier: Identifies events flagged manually as outliers, typically using the Event Editor in Movebank, and may also include outliers identified using other methods. Outliers have the value TRUE. Information about how outliers were defined can be provided in 'outlier comments'. units: none
entity described: event
...
ISS = Data are transferred via the International Space Station;
